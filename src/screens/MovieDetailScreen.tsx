...
import { View, Text, StyleSheet, Image, TouchableOpacity, ScrollView, FlatList, ActivityIndicator, Alert, TouchableWithoutFeedback, Animated, Modal } from 'react-native';
